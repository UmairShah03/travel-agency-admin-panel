...
import type { Route } from "./+types/TripsDetails";
  ...
  return (
    <main className="travel-detail wrapper">
      ...
      <section className="container wrapper-md">
        <header>
          <p className="p-40-semibold text-dark-100">{name}</p>
          <div className="flex items-center gap-5">
            ...
            />
            <InfoPill
              text={`${itinerary?.slice(0, 4).map((item) => item.location)}`}
            ...
            <ChipsDirective>
              {pillItem.map((item, i) => (
                <ChipDirective
                  ...
                  cssClass={`${item.bg} !text-base !px-4 !font-medium`}
                />
              ))}
            </ChipsDirective>
          </ChipListComponent>
